...
export default function Programmers() {
  ...
  const getNameOfFeatured = () => {
    ...
    // const foundProgrammer = programmer.find(p => p.id === programmerId)
    // const programmerName = foundProgrammer ? foundProgrammer.name : null
    // return programmerName

    return programmer.find(p => p.id === programmerId).name
  };
